...
# Load the dataset with rolling features
df = pd.read_csv("/Users/erikarispe/googleMachineLearning/nfl_team_game_stats_2024RollingAverages.csv")

# Handle missing values
fill_cols = [
    "REDZONETD%", "EPA_per_play", "PASS_EPA", "RUSH_EPA", "SUCCESS_RATE",
    "EPA_per_play_last3", "REDZONETD%_last3", "POINTSSCORED_last3", "OPPONENTPAG_last3"
]
